...
#define CONFIG_PLL_INPUT_CLK   20000000   /* HZ */
...
#define CONFIG_CKCPU_MGU_BLOCKS         0xff00
 ...
 ***********************************************/
/**** AHB BUS ****/
#define CK_AHBBUS_BASE			((volatile CK_UINT32*)(0x10000000))
...
/***** Uart *******/
#define CK_UART_ADDRBASE0    (volatile CK_UINT32 *)(0x50005000)

/**** Timer ****/
#define  CK_TIMER0_BASSADDR			(volatile CK_UINT32 *)(0x10011000)
#define  CK_TIMER1_BASSADDR			(volatile CK_UINT32 *)(0x10011014)
#define  CK_TIMER2_BASSADDR			(volatile CK_UINT32 *)(0x10011028)
#define  CK_TIMER3_BASSADDR			(volatile CK_UINT32 *)(0x1001103c)
