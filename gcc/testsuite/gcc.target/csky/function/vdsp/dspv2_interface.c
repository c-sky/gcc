...
#define TEST(func) \
  ...
  int8x4_t f_##func##s##_v4qi (int8x4_t a, int8x4_t b) \
    {                                                          \
      return func##_s8_s (a, b);               \
    }                                                          \
  int16x2_t f_##func##s##_v2hi (int16x2_t a, int16x2_t b) \
    {                                                          \
      return func##_s16_s (a, b);               \
    }                                                          \
  uint8x4_t f_##func##u##_v4qi (uint8x4_t a, uint8x4_t b) \
    {                                                          \
      return func##_u8_s (a, b);               \
    }                                                          \
  uint16x2_t f_##func##u##_v2hi (uint16x2_t a, uint16x2_t b) \
    {                                                          \
...
#define TEST9(func) \
  int8x4_t f_##func##_v4qi (int8x4_t a) \
    {                                                          \
      return func##_s8_s (a);               \
    }                                                          \
  int16x2_t f_##func##_v2hi (int16x2_t a) \
...
#define TEST13_1(func) \
  unsigned int f_##func##_v4qi (unsigned int in, uint8x4_t a, uint8x4_t b) \
    {                                                          \
      return func##_u8 (in, a, b);               \
    }
TEST13_1(psabsaa)
...
#define TEST18(func) \
  int16x2_t f_##func##s##_v2hi (int16x2_t a) \
    {                                                          \
...
#define TEST19(func) \
  int16x2_t f_##func##s##_v2hi (int16x2_t a, int b) \
    {                                                          \
      return func##_s16_s (a, b);               \
    }
TEST19(plsl)
...
#define TEST20(func) \
  uint16x2_t f_##func##u##_v2hi (uint16x2_t a) \
    {                                                          \
...
#define TEST21(func) \
  uint16x2_t f_##func##u##_v2hi (uint16x2_t a, int b) \
    {                                                          \
      return func##_u16_s (a, b);               \
    }
TEST21(plsl)
