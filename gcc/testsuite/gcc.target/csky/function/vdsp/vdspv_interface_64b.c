...
#define TEST(func) \
  int8x8_t f_##func##_v8qi (int8x8_t a) \
    {                                                          \
      return func##_s8 (a);               \
    }                                                          \
  int16x4_t f_##func##_v4hi (int16x4_t a) \
    {                                                          \
      return func##_s16 (a);               \
    }                                                          \
  int32x2_t f_##func##_v2si (int32x2_t a) \
    {                                                          \
      return func##_s32 (a);               \
    }                                                          \
  int8x8_t f_##func##s##_v8qi (int8x8_t a) \
    {                                                          \
      return func##_s8_s (a);               \
    }                                                          \
  int16x4_t f_##func##s##_v4hi (int16x4_t a) \
    {                                                          \
      return func##_s16_s (a);               \
    }                                                          \
  int32x2_t f_##func##s##_v2si (int32x2_t a) \
    {                                                          \
...
#define TEST2(func) \
  int16x4_t f_##func##_v8qise (int8x8_t a, int8x8_t b) \
    {                                                          \
      return func##_es8 (a, b);               \
    }                                                          \
  uint16x4_t f_##func##_v8qiue (uint8x8_t a, uint8x8_t b) \
    {                                                          \
      return func##_eu8 (a, b);               \
    }   \
  int32x2_t f_##func##_v4hise (int16x4_t a, int16x4_t b) \
    {                                                          \
      return func##_es16 (a, b);               \
    }                                                          \
  uint32x2_t f_##func##_v4hiue (uint16x4_t a, uint16x4_t b) \
    {                                                          \
...
#define TEST3(func) \
  int8x8_t f_##func##_v8qi (int8x8_t a, int8x8_t b) \
    {                                                          \
      return func##_s8 (a, b);               \
    }                                                          \
  int16x4_t f_##func##_v4hi (int16x4_t a, int16x4_t b) \
    {                                                          \
      return func##_s16 (a, b);               \
    }                                                          \
  int32x2_t f_##func##_v2si (int32x2_t a, int32x2_t b) \
    {                                                          \
      return func##_s32 (a, b);               \
    }                                                          \
  uint8x8_t f_##func##_v8qiu (uint8x8_t a, uint8x8_t b) \
    {                                                          \
      return func##_u8 (a, b);               \
    }                                                          \
  uint16x4_t f_##func##_v4hiu (uint16x4_t a, uint16x4_t b) \
    {                                                          \
      return func##_u16 (a, b);               \
    }                                                          \
  uint32x2_t f_##func##_v2siu (uint32x2_t a, uint32x2_t b) \
    {                                                          \
      return func##_u32 (a, b);               \
    }                                                          \
  int8x8_t f_##func##s##_v8qi (int8x8_t a, int8x8_t b) \
    {                                                          \
      return func##_s8_s (a, b);               \
    }                                                          \
  int16x4_t f_##func##s##_v4hi (int16x4_t a, int16x4_t b) \
    {                                                          \
      return func##_s16_s (a, b);               \
    }                                                          \
  int32x2_t f_##func##s##_v2si (int32x2_t a, int32x2_t b) \
    {                                                          \
      return func##_s32_s (a, b);               \
    }                                                          \
  uint8x8_t f_##func##u##_v8qi (uint8x8_t a, uint8x8_t b) \
    {                                                          \
      return func##_u8_s (a, b);               \
    }                                                          \
  uint16x4_t f_##func##u##_v4hi (uint16x4_t a, uint16x4_t b) \
    {                                                          \
      return func##_u16_s (a, b);               \
    }                                                          \
  uint32x2_t f_##func##u##_v2si (uint32x2_t a, uint32x2_t b) \
    {                                                          \
...
#define TEST4(func) \
  uint16x4_t f_##func##_v4hixu (uint8x8_t a, uint16x4_t b) \
    {                                                          \
      return func##_xu16 (a, b);               \
    }                                                          \
  uint32x2_t f_##func##_v2sixu (uint16x4_t a, uint32x2_t b) \
    {                                                          \
      return func##_xu32 (a, b);               \
    }   \
  int16x4_t f_##func##_v4hix (int8x8_t a, int16x4_t b) \
    {                                                          \
      return func##_xs16 (a, b);               \
    }                                                          \
  int32x2_t f_##func##_v2six (int16x4_t a, int32x2_t b) \
    {                                                          \
...
#define TEST5(func) \
  uint8x8_t f_##func##_v4hixusl (uint8x8_t a, uint16x4_t b) \
    {                                                          \
      return func##_xu16_sl (a, b);               \
    }                                                          \
  uint16x4_t f_##func##_v2sixusl (uint16x4_t a, uint32x2_t b) \
    {                                                          \
      return func##_xu32_sl (a, b);               \
    }   \
  int8x8_t f_##func##_v4hixsl (int8x8_t a, int16x4_t b) \
    {                                                          \
      return func##_xs16_sl (a, b);               \
    }                                                          \
  int16x4_t f_##func##_v2sixsl (int16x4_t a, int32x2_t b) \
    {                                                          \
...
#define TEST7(func) \
  int8x8_t f_##func##_v8qir (int8x8_t a, int8x8_t b) \
    {                                                          \
      return func##_s8_r (a, b);               \
    }                                                          \
  int16x4_t f_##func##_v4hir (int16x4_t a, int16x4_t b) \
    {                                                          \
      return func##_s16_r (a, b);               \
    }                                                          \
  int32x2_t f_##func##_v2sir (int32x2_t a, int32x2_t b) \
    {                                                          \
      return func##_s32_r (a, b);               \
    }                                                          \
  uint8x8_t f_##func##_v8qiur (uint8x8_t a, uint8x8_t b) \
    {                                                          \
      return func##_u8_r (a, b);               \
    }                                                          \
  uint16x4_t f_##func##_v4hiur (uint16x4_t a, uint16x4_t b) \
    {                                                          \
      return func##_u16_r (a, b);               \
    }                                                          \
  uint32x2_t f_##func##_v2siur (uint32x2_t a, uint32x2_t b) \
    {                                                          \
...
TEST8_1(vor)
/* { dg-final { scan-assembler-times "vor\.8" 2 } }*/
/* { dg-final { scan-assembler-times "vor\.16" 2 } }*/
/* { dg-final { scan-assembler-times "vor\.32" 2 } }*/
TEST8_1(vtst)
...
#define TEST12(func) \
  ...
  uint8x8_t f_##func##_v8qiu (uint8x8_t a) \
    {                                                          \
      return func##_u8 (a);               \
    }                                                          \
  uint16x4_t f_##func##_v4hiu (uint16x4_t a) \
    {                                                          \
      return func##_u16 (a);               \
    }                                                          \
  uint32x2_t f_##func##_v2siu (uint32x2_t a) \
    {                                                          \
      return func##_u32 (a);               \
    }
TEST12(vcmphsz)
...
#define TEST13(func) \
  ...
  uint8x8_t f_##func##u##_v8qi (uint8x8_t a) \
    {                                                          \
      return func##_u8 (a);               \
    }
TEST13(vcnt1)
/* { dg-final { scan-assembler-times "vcnt1\.8" 2 } }*/
...
#define TEST15(func) \
  int8x8_t f_##func##_v8qi (int8x8_t a) \
    {                                                          \
      return func##_8 (7, a, 7);               \
    }                                                          \
  int16x4_t f_##func##_v4hi (int16x4_t a) \
    {                                                          \
      return func##_16 (3, a, 3);               \
    }                                                          \
  int32x2_t f_##func##_v2si (int32x2_t a) \
    {                                                          \
      return func##_32 (1, a, 1);               \
    }
TEST15(vins)
...
#define TEST16(func) \
  int8x8_t f_##func##_v8qi (int a) \
    {                                                          \
      return func##_8 (a, 2032);               \
    }                                                          \
  int16x4_t f_##func##_v4hi (int a) \
    {                                                          \
      return func##_16 (a, 2032);               \
    }                                                          \
  int32x2_t f_##func##_v2si (int a) \
    {                                                          \
...
#define TEST17(func) \
  int8x8_t f_##func##_v8qi (int a, int b) \
    {                                                          \
      return func##_8 (a, b, 1);               \
    }                                                          \
  int16x4_t f_##func##_v4hi (int a, int b) \
    {                                                          \
      return func##_16 (a, b, 2);               \
    }                                                          \
  int32x2_t f_##func##_v2si (int a, int b) \
    {                                                          \
...
#define TEST18(func) \
  unsigned char f_##func##_v8qi (uint8x8_t a) \
    {                                                          \
      return func##_u8 (a, 7);               \
    }                                                          \
  unsigned short f_##func##_v4hi (uint16x4_t a) \
    {                                                          \
      return func##_u16 (a, 3);               \
    }                                                          \
  unsigned int f_##func##_v2si (uint32x2_t a) \
    {                                                          \
      return func##_u32 (a, 1);               \
    } \
  char f_##func##_v8qis (int8x8_t a) \
    {                                                          \
      return func##_s8 (a, 7);               \
    }                                                          \
  short f_##func##_v4his (int16x4_t a) \
    {                                                          \
...
#define TEST19(func) \
  uint8x8_t f_##func##_v8qi (unsigned char a) \
    {                                                          \
      return __builtin_csky_##func##v8qi (7, a);               \
    }                                                          \
  uint16x4_t f_##func##_v4hi (unsigned short a) \
    {                                                          \
      return __builtin_csky_##func##v4hi (3, a);               \
    }                                                          \
  uint32x2_t f_##func##_v2si (unsigned int a) \
    {                                                          \
...
#define TEST20(func) \
  int16x4_t f_##func##_v8qise (int8x8_t a) \
    {                                                          \
      return func##_es8 (a);               \
    }                                                          \
  uint16x4_t f_##func##_v8qiue (uint8x8_t a) \
    {                                                          \
      return func##_eu8 (a);               \
    }   \
  int32x2_t f_##func##_v4hise (int16x4_t a) \
    {                                                          \
      return func##_es16 (a);               \
    }                                                          \
  uint32x2_t f_##func##_v4hiue (uint16x4_t a) \
    {                                                          \
      return func##_eu16 (a);               \
    }
TEST20(vmov)
...
#define TEST21(func, type) \
  uint8x8_t f_##func##_v4hiu##type (uint16x4_t a) \
    {                                                          \
      return func##_u16_##type (a);               \
    }                                                          \
  uint16x4_t f_##func##_v2siu##type (uint32x2_t a) \
    {                                                          \
      return func##_u32_##type (a);               \
    } \
  int8x8_t f_##func##_v4his##type (int16x4_t a) \
    {                                                          \
      return func##_s16_##type (a);               \
    }                                                          \
  int16x4_t f_##func##_v2sis##type (int32x2_t a) \
    {                                                          \
...
#define TEST22(func) \
  uint16x4_t f_##func##_v8qiu (uint8x8_t a, uint8x8_t b, uint16x4_t c) \
    {                                                          \
      return func##_eu8 (a, b, c);               \
    }                                                          \
  uint32x2_t f_##func##_v4hiu (uint16x4_t a, uint16x4_t b, uint32x2_t c) \
    {                                                          \
      return func##_eu16 (a, b, c);               \
    } \
  int16x4_t f_##func##_v8qis (int8x8_t a, int8x8_t b, int16x4_t c) \
    {                                                          \
      return func##_es8 (a, b, c);               \
    }                                                          \
  int32x2_t f_##func##_v4hi (int16x4_t a, int16x4_t b, int32x2_t c) \
    {                                                          \
...
#define TEST23(func) \
  int8x8_t f_##func##_v8qir (int8x8_t a, int8x8_t b, int8x8_t c) \
    {                                                          \
      return func##_s8 (a, b, c);               \
    }                                                          \
  int16x4_t f_##func##_v4hir (int16x4_t a, int16x4_t b, int16x4_t c) \
    {                                                          \
      return func##_s16 (a, b, c);               \
    }                                                          \
  int32x2_t f_##func##_v2sir (int32x2_t a, int32x2_t b, int32x2_t c) \
    {                                                          \
      return func##_s32 (a, b, c);               \
    }                                                          \
  uint8x8_t f_##func##_v8qiur (uint8x8_t a, uint8x8_t b, uint8x8_t c) \
    {                                                          \
      return func##_u8 (a, b, c);               \
    }                                                          \
  uint16x4_t f_##func##_v4hiur (uint16x4_t a, uint16x4_t b, uint16x4_t c) \
    {                                                          \
      return func##_u16 (a, b, c);               \
    }                                                          \
  uint32x2_t f_##func##_v2siur (uint32x2_t a, uint32x2_t b, uint32x2_t c) \
    {                                                          \
...
#define TEST24(func) \
  ...
  uint16x4_t f_##func##u##_v4hi (uint16x4_t a) \
    {                                                          \
      return func##_u16_s (a, 3);               \
    }                                                          \
  uint32x2_t f_##func##u##_v2si (uint32x2_t a) \
    {                                                          \
...
#define TEST25(func, type) \
  int8x8_t f_##func##_v8qi_##type (int8x8_t a, int8x8_t b) \
    {                                                          \
      return func##_s8_##type (a, b);               \
    }                                                          \
  int16x4_t f_##func##_v4hi_##type (int16x4_t a, int16x4_t b) \
    {                                                          \
      return func##_s16_##type (a, b);               \
    }                                                          \
  int32x2_t f_##func##_v2si_##type (int32x2_t a, int32x2_t b) \
    {                                                          \
      return func##_s32_##type (a, b);               \
    }                                                          \
  uint8x8_t f_##func##_v8qiu_##type (uint8x8_t a, uint8x8_t b) \
    {                                                          \
      return func##_u8_##type (a, b);               \
    }                                                          \
  uint16x4_t f_##func##_v4hiu_##type (uint16x4_t a, uint16x4_t b) \
    {                                                          \
      return func##_u16_##type (a, b);               \
    }                                                          \
  uint32x2_t f_##func##_v2siu_##type (uint32x2_t a, uint32x2_t b) \
    {                                                          \
...
#define TEST27(func, type) \
  int8x8_t f_##func##_v8qi##type (int8x8_t a) \
    {                                                          \
      return func##_s8_##type (a, 3);               \
    }                                                          \
  int16x4_t f_##func##_v4hi##type (int16x4_t a) \
    {                                                          \
      return func##_s16_##type (a, 3);               \
    }                                                          \
  int32x2_t f_##func##_v2si##type (int32x2_t a) \
    {                                                          \
      return func##_s32_##type (a, 3);               \
    }                                                          \
  uint8x8_t f_##func##_v8qiu##type (uint8x8_t a) \
    {                                                          \
      return func##_u8_##type (a, 3);               \
    }                                                          \
  uint16x4_t f_##func##_v4hiu##type (uint16x4_t a) \
    {                                                          \
      return func##_u16_##type (a, 3);               \
    }                                                          \
  uint32x2_t f_##func##_v2siu##type (uint32x2_t a) \
    {                                                          \
