...
#define TEST(func) \
  ...
  int8x16_t f_##func##s##_v16qi (int8x16_t a) \
    {                                                          \
      return func##_s8_s (a);               \
    }                                                          \
  int16x8_t f_##func##s##_v8hi (int16x8_t a) \
    {                                                          \
      return func##_s16_s (a);               \
    }                                                          \
  int32x4_t f_##func##s##_v4si (int32x4_t a) \
    {                                                          \
...
#define TEST3(func) \
  ...
  int8x16_t f_##func##s##_v16qi (int8x16_t a, int8x16_t b) \
    {                                                          \
      return func##_s8_s (a, b);               \
    }                                                          \
  int16x8_t f_##func##s##_v8hi (int16x8_t a, int16x8_t b) \
    {                                                          \
      return func##_s16_s (a, b);               \
    }                                                          \
  int32x4_t f_##func##s##_v4si (int32x4_t a, int32x4_t b) \
    {                                                          \
      return func##_s32_s (a, b);               \
    }                                                          \
  uint8x16_t f_##func##u##_v16qi (uint8x16_t a, uint8x16_t b) \
    {                                                          \
      return func##_u8_s (a, b);               \
    }                                                          \
  uint16x8_t f_##func##u##_v8hi (uint16x8_t a, uint16x8_t b) \
    {                                                          \
      return func##_u16_s (a, b);               \
    }                                                          \
  uint32x4_t f_##func##u##_v4si (uint32x4_t a, uint32x4_t b) \
    {                                                          \
...
#define TEST6_1(func) \
  uint8x16_t f_##func##_v16qi (int8x16_t a, int8x16_t b) \
    {                                                          \
      return func##_s8 (a, b);               \
    }                                                          \
  uint16x8_t f_##func##_v8hi (int16x8_t a, int16x8_t b) \
    {                                                          \
      return func##_s16 (a, b);               \
    }                                                          \
  uint32x4_t f_##func##_v4si (int32x4_t a, int32x4_t b) \
    {                                                          \
      return func##_s32 (a, b);               \
    }                                                          \
  uint8x16_t f_##func##_v16qiu (uint8x16_t a, uint8x16_t b) \
...
#define TEST8_1(func) \
  int8x16_t f_##func##s##v16qi (int8x16_t a, int8x16_t b) \
    {                                                          \
      return func##_s8 (a, b);               \
    }                                                          \
  int16x8_t f_##func##s##_v8hi (int16x8_t a, int16x8_t b) \
...
#define TEST13(func) \
  uint8x16_t f_##func##u##_v16qi (uint8x16_t a) \
    {                                                          \
      return func##_u8 (a);               \
    }                                     \
  int8x16_t f_##func##s##_v16qi (int8x16_t a) \
...
#define TEST24(func) \
  ...
  uint16x8_t f_##func##u##_v8hi (uint16x8_t a) \
    {                                                          \
      return func##_u16_s (a, 3);               \
    }                                                          \
  uint32x4_t f_##func##u##_v4si (uint32x4_t a) \
    {                                                          \
