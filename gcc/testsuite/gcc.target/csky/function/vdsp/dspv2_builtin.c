...
#define TEST(func) \
  ...
  __simd32_int8_t f_##func##ss##_v4qi (__simd32_int8_t a, __simd32_int8_t b) \
    {                                                          \
      return __builtin_csky_##func##ss##v4qi (a, b);               \
    }                                                          \
  __simd32_int16_t f_##func##ss##_v2hi (__simd32_int16_t a, __simd32_int16_t b) \
    {                                                          \
      return __builtin_csky_##func##ss##v2hi (a, b);               \
    }                                                          \
  __simd32_uint8_t f_##func##us##_v4qi (__simd32_uint8_t a, __simd32_uint8_t b) \
    {                                                          \
      return __builtin_csky_##func##us##v4qi (a, b);               \
    }                                                          \
  __simd32_uint16_t f_##func##us##_v2hi (__simd32_uint16_t a, __simd32_uint16_t b) \
    {                                                          \
      return __builtin_csky_##func##us##v2hi (a, b);               \
    }
TEST(padd)
...
#define TEST8(func) \
  __simd32_int8_t f_##func##_v4qi (__simd32_int8_t a) \
    {                                                          \
      return __builtin_csky_##func##v4qi (a);               \
    }                                                          \
  __simd32_int16_t f_##func##_v2hi (__simd32_int16_t a) \
    {                                                          \
      return __builtin_csky_##func##v2hi (a);               \
    }                                                          
TEST8(ssabs)
...
#define TEST13(func) \
  unsigned int f_##func##_v4qi (__simd32_uint8_t a, __simd32_uint8_t b) \
    {                                                          \
      return __builtin_csky_##func##v4qi (a, b);               \
    }
TEST13(psabsa)
...
#define TEST13(func) \
  unsigned int f_##func##_v4qi (unsigned int in, __simd32_uint8_t a, __simd32_uint8_t b) \
    {                                                          \
      return __builtin_csky_##func##v4qi (in, a, b);               \
    }
TEST13_1(psabsaa)
